...
namespace SyberGate.RMACT.Web.Authentication.JwtBearer
{
    public class RMACTJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public RMACTJwtSecurityTokenHandler()
        {
