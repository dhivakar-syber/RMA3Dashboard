...
{
    public class SubscriptionPaymentExtensionDataRepository : RMACTRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<RMACTDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
