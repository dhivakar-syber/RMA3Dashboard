...
{
    public class SubscriptionPaymentRepository : RMACTRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<RMACTDbContext> dbContextProvider)
