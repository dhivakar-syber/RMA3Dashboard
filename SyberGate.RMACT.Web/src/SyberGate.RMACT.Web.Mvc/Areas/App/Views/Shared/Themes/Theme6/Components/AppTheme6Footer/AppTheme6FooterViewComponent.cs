...
namespace SyberGate.RMACT.Web.Areas.App.Views.Shared.Themes.Theme6.Components.AppTheme6Footer
{
    public class AppTheme6FooterViewComponent : RMACTViewComponent
    {
