...
namespace SyberGate.RMACT.Web.Areas.App.Views.Shared.Themes.Theme8.Components.AppTheme8Footer
{
    public class AppTheme8FooterViewComponent : RMACTViewComponent
    {
