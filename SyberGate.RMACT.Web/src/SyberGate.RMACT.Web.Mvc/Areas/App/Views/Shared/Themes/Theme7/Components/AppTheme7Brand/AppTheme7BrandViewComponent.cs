...
namespace SyberGate.RMACT.Web.Areas.App.Views.Shared.Themes.Theme7.Components.AppTheme7Brand
{
    public class AppTheme7BrandViewComponent : RMACTViewComponent
    {
