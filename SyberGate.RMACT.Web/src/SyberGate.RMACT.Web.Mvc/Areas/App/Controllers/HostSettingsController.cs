...
using SyberGate.RMACT.Configuration.Host;
using SyberGate.RMACT.Editions;
using SyberGate.RMACT.Timing;
using SyberGate.RMACT.Timing.Dto;
using SyberGate.RMACT.Web.Areas.App.Models.HostSettings;
...
namespace SyberGate.RMACT.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : RMACTControllerBase
    {
