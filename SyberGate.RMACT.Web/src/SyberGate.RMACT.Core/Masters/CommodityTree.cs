...
{
    /// <summary>
    /// Represents an Commodity Tree (CT).
    /// </summary>
    [Table("CommodityTrees")]
    public class CommodityTree : FullAuditedEntity<long>, IMayHaveTenant
    {
        /// <summary>
        ...
        /// <summary>
        /// Maximum depth of an CT hierarchy.
        /// </summary>
        ...
        /// <summary>
        /// Parent <see cref="CommodityTree"/>.
        /// Null, if this OU is root.
        /// </summary>
        [ForeignKey("ParentId")]
        public virtual CommodityTree Parent { get; set; }

        /// <summary>
        /// Parent <see cref="CommodityTree"/> Id.
        /// Null, if this OU is root.
        /// </summary>
        ...
        /// Children of this OU.
        /// </summary>
        public virtual ICollection<CommodityTree> Children { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="CommodityTree"/> class.
        /// </summary>
        public CommodityTree()
        {
        ...
        public CommodityTree(int? tenantId, string displayName, long? parentId = null, bool? isLeaf = null)
        {
            TenantId = tenantId;
