...
namespace SyberGate.RMACT.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : RMACTServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("SyberGate.RMACT", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
