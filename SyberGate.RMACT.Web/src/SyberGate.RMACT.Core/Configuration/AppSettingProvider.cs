...
using SyberGate.RMACT.Authentication;
...
namespace SyberGate.RMACT.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!RMACTConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        RMACTConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    ...
                    RMACTDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson,
                    scopes: SettingScopes.User, isVisibleToClients: true),
                new SettingDefinition(
                    AppSettings.DashboardCustomization.Configuration + "." +
                    RMACTDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson,
                    scopes: SettingScopes.User, isVisibleToClients: true),
                new SettingDefinition(
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = RMACTDashboardCustomizationConsts.DashboardNames.RMA3Dashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = RMACTDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = RMACTDashboardCustomizationConsts.Widgets.Tenant.RMPriceTrend,
                                    Height = 150,
                                    Width = 10,
                                    PositionX = 0,
                                    PositionY = 19
                                ...
                                // new Widget
                                //{
                                //    WidgetId = RMACTDashboardCustomizationConsts.Widgets.Tenant.RMPriceImpactStats,
                                //    Height = 15,
                                //    Width = 30,
                                //    PositionX = 0,
                                //    PositionY = 19
                ...
                new Dashboard
                {
                    DashboardName = RMACTDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = RMACTDashboardCustomizationConsts.Widgets.Tenant
                                ...
                                {
                                    WidgetId =
                                        RMACTDashboardCustomizationConsts.Widgets.Tenant
                 ...
                 new Dashboard
                 {
                    DashboardName = RMACTDashboardCustomizationConsts.DashboardNames.AnalysisDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                ...
                new Dashboard
                {
                    DashboardName = RMACTDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = RMACTDashboardCustomizationConsts.Widgets.Host
                                        .TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                ...
                                {
                                    WidgetId =
                                        RMACTDashboardCustomizationConsts.Widgets.Host
