...
namespace SyberGate.RMACT.Web.TagHelpers
{
    ...
    public class RMACTPageSubheaderTagHelper : TagHelper
    {
        ...
        public RMACTPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
