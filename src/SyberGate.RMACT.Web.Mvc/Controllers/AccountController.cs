...
namespace SyberGate.RMACT.Web.Controllers
{
    public class AccountController : RMACTControllerBase
    {
        ...
        private readonly TenantDashboardAppService _tenantdashboardservice;
        private readonly A3DocumentsAppService _a3documentappservice;
        private readonly A3DocumentsController _a3DocumentsController;
        public AccountController(
            ...
            TenantDashboardAppService tenantdashboardservice,
            A3DocumentsAppService a3documentappservice,
            A3DocumentsController a3DocumentsController)
        {
            ...
            _a3documentappservice= a3documentappservice;
            _a3DocumentsController= a3DocumentsController;
        }
        ...
        public async Task<ActionResult>EmailApproval(string returnUrl = "", string ss = "", int A3Id=0, string Buyername="", string Suppliername="", string Token="", bool Issequnce = false,string Confirmation="Submit", int uid = 0,string buyerRemarks="",string version="")
        {
            return ApproveTenantDashboardservice(new EmailViewModel
            {
                PasswordComplexitySetting = await _passwordComplexitySettingStore.GetSettingsAsync(),
                ReturnUrl = returnUrl,
                SingleSignIn = ss,
        ...
        //public Task TenantDashboardservice(int A3Id, string Buyername, string Suppliername, string L4ApprovalToken, string CpApprovalToken, string FnApprovalToken)
        //{
        //    EntityDto newdto = new EntityDto(A3Id);

        //    return _a3documentappservice.EmailApprove(newdto);

        //    // return _a3DocumentsController.ListA3Documents(Buyername);
        //}

        public ActionResult ApproveTenantDashboardservice(EmailViewModel model)
        {
            ViewBag.UseCaptcha = !model.IsExternalLogin && UseCaptchaOnRegistration();

            return View("_EmailApproval", model);
