(function () {
    $(function () {
        ...
        var _entityTypeFullName = 'Abp.CommodityTree';

        var _permissions = {
            manageCommodityTree: abp.auth.hasPermission('Pages_CommodityTrees_ManageCommodityTree')
        };

        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/CommodityTrees/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/CommodityTrees/_CreateModal.js',
            modalClass: 'CreateCommodityTreeModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/CommodityTrees/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/CommodityTrees/_EditModal.js',
        ...
        var commodityTree = {
            ...
            contextMenu: function (node) {
                ...
                var items = {
                    ...
                    addSubCmo: {
                        label: app.localize('AddSubCommodity'),
                        icon: 'la la-plus',
                        _disabled: !_permissions.manageCommodityTree,
                        action: function () {
