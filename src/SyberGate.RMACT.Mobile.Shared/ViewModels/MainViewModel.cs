...
using SyberGate.RMACT.Commands;
...
using SyberGate.RMACT.Controls;
using SyberGate.RMACT.Dto;
using SyberGate.RMACT.Extensions;
using SyberGate.RMACT.Localization;
using SyberGate.RMACT.UI;
using SyberGate.RMACT.UI.Assets;
using SyberGate.RMACT.Views;
using DependencyResolver = SyberGate.RMACT.Core.Dependency.DependencyResolver;
...
namespace SyberGate.RMACT.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "RMACT";
