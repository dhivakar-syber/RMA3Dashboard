...
using SyberGate.RMACT.MultiTenancy.Demo;
...
namespace SyberGate.RMACT.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(RMACTConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(RMACTConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
