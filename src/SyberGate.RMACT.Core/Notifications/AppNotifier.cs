...
namespace SyberGate.RMACT.Notifications
{
    public class AppNotifier : RMACTDomainServiceBase, IAppNotifier
    {
        ...
        public Task SomePartsCouldntBeImported(UserIdentifier user, string fileToken, string fileType, string fileName)
        {
            return SendNotificationAsync(AppNotificationNames.DownloadInvalidImportUsers, user,
                new LocalizableString(
                    "ClickToSeeInvalidParts",
                    RMACTConsts.LocalizationSourceName
                ),
                new Dictionary<string, object>
                {
