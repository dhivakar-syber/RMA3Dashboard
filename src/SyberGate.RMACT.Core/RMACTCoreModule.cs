...
using SyberGate.RMACT.Authorization.Ldap;
...
using SyberGate.RMACT.DashboardCustomization.Definitions;
using SyberGate.RMACT.Debugging;
using SyberGate.RMACT.DynamicEntityProperties;
using SyberGate.RMACT.Features;
...
using SyberGate.RMACT.WebHooks;

namespace SyberGate.RMACT
{
    [DependsOn(
        typeof(RMACTCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class RMACTCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            RMACTLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = RMACTConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, RMACTMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<RMACTSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RMACTCoreModule).GetAssembly());
        }
