...
using SyberGate.RMACT.Web.Startup.ExternalLoginInfoProviders;
...
namespace SyberGate.RMACT.Web.Startup
{
    ...
    public class RMACTWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public RMACTWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RMACTWebHostModule).GetAssembly());
        }
