...
namespace SyberGate.RMACT.Web.Public.Startup
{
    [DependsOn(
        typeof(RMACTWebCoreModule)
    )]
    public class RMACTWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public RMACTWebFrontEndModule(IWebHostEnvironment env, RMACTEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RMACTWebFrontEndModule).GetAssembly());
        }
    }
}
