...
using SyberGate.RMACT.Web.Public.Startup;
using SyberGate.RMACT.Web.Session;

namespace SyberGate.RMACT.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : RMACTViewComponent
    {
