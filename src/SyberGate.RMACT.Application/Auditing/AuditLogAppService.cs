...
using SyberGate.RMACT.Auditing.Exporting;
using SyberGate.RMACT.Authorization;
using SyberGate.RMACT.Authorization.Users;
using SyberGate.RMACT.Dto;
using SyberGate.RMACT.EntityHistory;
using EntityHistoryHelper = SyberGate.RMACT.EntityHistory.EntityHistoryHelper;

namespace SyberGate.RMACT.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : RMACTAppServiceBase, IAuditLogAppService
    {
