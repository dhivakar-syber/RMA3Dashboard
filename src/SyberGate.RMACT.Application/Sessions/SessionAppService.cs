...
using SyberGate.RMACT.UiCustomization;
...
{
    public class SessionAppService : RMACTAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = RMACTConsts.Currency,
                    CurrencySign = RMACTConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = RMACTConsts.AllowTenantsToChangeEmailSettings,
