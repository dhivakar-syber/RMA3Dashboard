...
using SyberGate.RMACT.DynamicEntityPropertyValues.Dto;

namespace SyberGate.RMACT.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : RMACTAppServiceBase, IDynamicEntityPropertyValueAppService
    {
