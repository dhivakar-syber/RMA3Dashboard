...
namespace SyberGate.RMACT.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : RMACTAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<RMACTDbContext> _migrator;
        ...
        public string GetTemplatePath()
        {
            ...
            if (appUrl["TemplatePath"].IsNullOrEmpty())
            {
                return "";
            }

            return appUrl["TemplatePath"]; ;
        }
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{RMACTConsts.ConnectionStringName}", constring);
        }
